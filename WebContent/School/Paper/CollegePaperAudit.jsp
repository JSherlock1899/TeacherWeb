		...
		<div class="row">
			<div class="col-md-11 col-md-offset-1 ">
				...
				<ul class="pagination" style="display:block">
					...
					<li>
						<a href="../servlet/AuditServlet?option=Paper&currentPage=1" id="homePage">首页</a>
					</li>
					<li>
						<a aria-label="Previous" id="pre" class="prenextpage" href="../servlet/AuditServlet?option=Paper&currentPage=<%=currentPage - 1%>&pageSize=5
					"> 
							<span >&laquo;</span>
						</a>
					</li>
					<li><a class="page" href="../servlet/AuditServlet?option=Paper&currentPage=<%=pageArr[0]%>&pageSize=5
					"><%=pageArr[0]%></a></li>
					<li><a class="page" href="../servlet/AuditServlet?option=Paper&currentPage=<%=pageArr[1]%>&pageSize=5
					"><%=pageArr[1]%></a></li>
					<li><a class="page" href="../servlet/AuditServlet?option=Paper&currentPage=<%=pageArr[2]%>&pageSize=5
					"><%=pageArr[2]%></a></li>
					<li><a class="page" href="../servlet/AuditServlet?option=Paper&currentPage=<%=pageArr[3]%>&pageSize=5
					"><%=pageArr[3]%></a></li>
					<li><a class="page" href="../servlet/AuditServlet?option=Paper&currentPage=<%=pageArr[4]%>&pageSize=5
					"><%=pageArr[4]%></a></li>
					<li>
						<a id="next" aria-label="Next" class="prenextpage" href="../servlet/AuditServlet?option=Paper&currentPage=<%=currentPage + 1%>&pageSize=5
					"> 
							<span>&raquo;</span>
						</a>
					</li>
					<li><a href="../servlet/AuditServlet?option=Paper&currentPage=<%=totalPage %>" id="endPage" >尾页</a></li>
