		...
		<div class="row">
			<div class="col-md-11 col-md-offset-1 ">
				...
				<ul class="pagination" style="display:block">
					...
					<li><a class="page" href="../servlet/PageServlet?option=Paper&currentPage=<%=pageArr[0]%>&pageSize=5&teacher=teacher
					"><%=pageArr[0]%></a></li>
					<li><a class="page" href="../servlet/PageServlet?option=Paper&currentPage=<%=pageArr[1]%>&pageSize=5&teacher=teacher
					"><%=pageArr[1]%></a></li>
					<li><a class="page" href="../servlet/PageServlet?option=Paper&currentPage=<%=pageArr[2]%>&pageSize=5&teacher=teacher
					"><%=pageArr[2]%></a></li>
					<li><a class="page" href="../servlet/PageServlet?option=Paper&currentPage=<%=pageArr[3]%>&pageSize=5&teacher=teacher
					"><%=pageArr[3]%></a></li>
					<li><a class="page" href="../servlet/PageServlet?option=Paper&currentPage=<%=pageArr[4]%>&pageSize=5&teacher=teacher
					"><%=pageArr[4]%></a></li>
					<li>
