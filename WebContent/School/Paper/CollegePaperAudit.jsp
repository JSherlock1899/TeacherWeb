		...
		<div class="row">
			<div class="col-md-11 col-md-offset-1 ">
				<div class="col-md-10 button-div form-inline">
					<table border="1" id="table" class="table table-striped table-bordered table-hover table-condensed">
							...
							<tr>
								...
								<td class="Paname edit"><a href="../servlet/AuditServlet?count=1&order=<%=i %>&option=Paper&college=<%=college%>
								&pageSize=<%=pageSize%>&currentPage=<%=currentPage%>"><%=datalist.get(i).getPaname()%></a></td>
				...
				<ul class="pagination" style="display:block">
					...
					<li>
						<a href="../servlet/AuditServlet?option=Paper&currentPage=1&college=<%=college %>&pageSize=<%=pageSize%>" id="homePage">首页</a>
					</li>
					<li>
						<a aria-label="Previous" id="pre" class="prenextpage" href="../servlet/AuditServlet?option=Paper&college=<%=college %>&currentPage=<%=currentPage - 1%>&pageSize=<%=pageSize%>
					"> 
							<span >&laquo;</span>
						</a>
					</li>
					<li id="page1"><a class="page" href="../servlet/AuditServlet?option=Paper&currentPage=<%=pageArr[0]%>&pageSize=<%=pageSize%>&college=<%=college %>
					"><%=pageArr[0]%></a></li>
					<li id="page2"><a class="page" href="../servlet/AuditServlet?option=Paper&currentPage=<%=pageArr[1]%>&pageSize=<%=pageSize%>&college=<%=college %>
					"><%=pageArr[1]%></a></li>
					<li id="page3"><a class="page" href="../servlet/AuditServlet?option=Paper&currentPage=<%=pageArr[2]%>&pageSize=<%=pageSize%>&college=<%=college %>
					"><%=pageArr[2]%></a></li>
					<li>
						<a id="next" aria-label="Next" class="prenextpage" href="../servlet/AuditServlet?option=Paper&currentPage=<%=currentPage + 1%>&pageSize=<%=pageSize%>&college=<%=college %>
					"> 
							<span>&raquo;</span>
						</a>
					</li>
					<li><a href="../servlet/AuditServlet?option=Paper&currentPage=<%=totalPage %>&college=<%=college %>&pageSize=<%=pageSize%>" id="endPage" >尾页</a></li>
