...
<script type="text/javascript" src="/TeacherWeb/UI/JS/alterPassword.js"></script>
<script type="text/javascript" src="/TeacherWeb/UI/JS/jquery.validate.v1.3.1.js"></script>
<title>修改密码</title>
</head>
<body>
	<%
		String Tsn = (String) session.getAttribute("Tsn");
	%>
	<div class="main main-bg w" style="display: block;width:100%">
    <div class="main-cont mAuto" style="margin-left:120px;margin-top:100px">
        <div class="box-one js-div add-top-julli hide" style="display: block;">
            <form action="../../servlet/PasswordServlet">
            	<input type="hidden" id="Tname" name="Tsn" value="<%=Tsn %>"/>
